      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="space-y-3">
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            >
              <div className="flex-1">
                <div className="text-sm font-medium text-gray-700">🏦 Contas Bancárias para Importação</div>
                <p className="text-xs text-gray-500 mt-1">{bancos.length} banco(s) configurado(s)</p>
              </div>
              <svg
            ...
            {secoesExpanded.bancos && (
              <div className="p-4 bg-white border-t border-gray-200">
                <p className="text-sm text-gray-600 mb-4">
                  Configure contas, layouts de importação e regras de classificação.
                </p>
                <a
